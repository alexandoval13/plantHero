...
const Form = (props) => {
  ...
  return (
    <div className={styles['form-container']}>
      ...
      <form
        className={styles['add-plant-form']}
        onSubmit={(e) => {
          props.handleSubmitPlant(e);
        }}
      >
        <h4>Name:</h4>
        <input
          type="text"
          name="plant-name"
          placeholder="What kind of plant did you get?"
        />
        ...
        <input
          type="number"
          name="watering-cycle-amount"
          placeholder="How many times..."
        />
        <Select
          className={styles['select-input']}
          name="watering-cycle-period"
        ...
        <Select
          className={styles['select-input']}
          placeholder="What kind of light does your plant like?"
          name="light-level"
          options={[
            { value: 'low', label: 'Low' },
        ...
        <Select
          className={styles['select-input']}
          name="humidity"
          placeholder={`Feelings about the word \"moist\"?`}
          options={[
            { value: 'low', label: 'Low' },
            { value: 'moderate', label: 'Moderate' },
        ...
        <Select
          className={styles['select-input']}
          name="categories"
          placeholder={`Let\'s sort some things out.`}
          options={getValues(props.categories)}
          isMulti
        />
